...
**Answer**
Different casetypes for the same cities.
```{r}
...
**Answer**
The cases for the names have been standardized.
```{r}
...
**Answer**
Cases and spelling have been standardized.
```{r}
cleaned_md_loans %>%
...
md_loans_new <- read_csv("Maryland-PPP-2-22-22.csv")
