...
https://datawrapper.dwcdn.net/RKV9p/1/
...
dropping anything with less than 6 loans to remove erroneous counties.
...
state and county codes combined
...
Counties and fips codes together at last
```{r}
...
Now we only see Maryland counties because that's what we have data for
...
https://datawrapper.dwcdn.net/fG9Mk/1/