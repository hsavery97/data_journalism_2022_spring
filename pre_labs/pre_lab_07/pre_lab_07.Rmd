...
**Answer**
2 digit NAICS codes representing broad categories of industry, e.g. information or construction. 
...
**Answer**
All 6 dataframes have been collapsed down to the one we want, which is number 2
...
**Answer** 20x2 codes and industries
```{r}
...
**Answer**
The beginnings of a nice table.
```{r}
...
**Answer**
A dataframe with two columns and one row.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Mining, Quarrying, and Oil and Gas Extraction statistics
...
**Answer**
Nothing, however it does change the data set.
```{r}
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
You won't believe it, but we have the same list of sectors.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
Error because 'sector_name' doesn't exist.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
We see 1 to 10, I couldn't have ordered them better myself.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer**
You have the sector numbers and their corresponding industries.
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
We see the industry codes and corresponding industries.
```{r}
# Define url of page we want to scrape
...
**Answer**
The tibble is now 20 rows and 3 columns including the URLs
```{r}
...
**Answer**
Same thing, but Public Administration is removed because it's irrelevant. 
...
**Answer**
Sector number, industry, and number of employees in one pretty snazzy table.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Mining, Quarrying, and Oil and Gas Extraction stats
### Task 37: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Agriculture, Forestry, Fishing and Hunting stats
### Task 39: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Answer**
Ag is still listed it just doesnt have a number of employees listed
