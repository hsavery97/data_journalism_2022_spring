...
**Answer**
Many columns, 33 to be exact, looks like a dataframe, quacks like a dataframe.Has a fancy geometry column.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Hospitals grouped by type, i.e. general, psychiatric, military, etc. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
County dataframe with a pretty snazzy geometry column
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A dataframe with only Maryland counties
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Maryland, but if they drained the bay.
```{r}
md_counties %>%
  ggplot() + 
  geom_sf() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Hospitals overlayed on the counties
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
We've added grading for the number of beds.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Dataframe with population and geometry column, could be used on a map
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
renaming and mutating so we can join
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
beds per 100k joined with county pop
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Actually doing the math for beds per 100k
```{r}
md_beds_per_100k <- md_county_population %>%
  left_join(md_beds_by_county) %>%
  mutate(total_beds = replace_na(total_beds,0)) %>%
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Map time baby, and we can see the water this time.
```{r}
ggplot() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Heat map that makes it wasier to see the outliers.
```{r}
ggplot() + 
  geom_sf(data=md_beds_per_100k, aes(fill=beds_per_100k)) + 
  theme_minimal() +
