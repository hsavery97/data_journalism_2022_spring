...
##The last few lines are apparently unnecessary but here they are anyway, enjoy!##
...
zip_X_counties_collab<-md_zips_and_vax%>%
  inner_join(md_counties, by=c("GEOID"))
  ...
  geom_sf(data=md_zips_and_vax,
    aes(fill=percent_shotted))+
  theme_minimal()+
    scale_fill_viridis_b(option="magma", trans="log")+
    labs(title=paste("Percent of population fully vaccinated on",md_zips_and_vax$date, sep=""))
```
