...
```{r}
total_pop_by_zip <- get_acs(geography = "zcta", variables = c(pop = "B01003_001"), year = 2019)
black_pop_by_zip<-get_acs(geography = "zcta", variables = c(blackpop =  "B01003_001"), year = 2019)

percentage_black_pop<-total_pop_by_zip%>%
  inner_join(total_black_)
