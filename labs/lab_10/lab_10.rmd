...
barber_loans_forgiven<-barber_shops%>%
...
barber_undisbursed_and_total_and_forgiven<-barber_undisbursed_and_total%>%
  inner_join(barber_loans_forgiven, by=c("state"))%>%
 rename(forgiven_loans=total_loans)%>%
  arrange(desc(total_apps))%>%
    head(10)

write_csv(barber_undisbursed_and_total_and_forgiven, "data/top_states_w_forgiveness.csv")
